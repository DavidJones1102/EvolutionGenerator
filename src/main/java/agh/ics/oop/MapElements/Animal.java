...
public class Animal extends AbstractMapElement {
    ...
    private boolean highlight = false;  // czy zwierzę powinno o tym wiedzieć?
    ...
    public void move() {
        ...
        Vector2d v = orientation.toUnitVector();  // mało wymowna nazwa
        Vector2d newPosition = position.add(v);

        Vector2d oldPosition = position;
        if (settings.mapVariant) {  // if nie jest najlepszym rozwiązaniem; a if w zwierzęciu jest wręcz bardzo zły
