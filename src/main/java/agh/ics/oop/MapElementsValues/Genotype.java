...
public class Genotype {
    ...
    public Genotype(Animal animal1, Animal animal2) {//!! lewa prawa strona genotypu ma być wylosowana
        ...
        for (int i = 0; i < genesFrom1; i++) {  // https://docs.oracle.com/javase/7/docs/api/java/lang/System.html#arraycopy(java.lang.Object,%20int,%20java.lang.Object,%20int,%20int)
    ...
    public int getGene(boolean variant) { // boolean?
    ...
    public int[] getGenes() {  // dehermetyzacja
        return genes;
    }
